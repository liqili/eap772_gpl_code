...
#define LLDPD_MAX_NEIGHBORS	8
#define LLDPD_FAST_TX_INTERVAL	1
#define LLDPD_FAST_INIT	4

#define USING_AGENTX_SUBAGENT_MODULE 1

#define LLDP_SHMEM_KEY_ID 0xC11E0767
#define LLDP_SEM_KEY_ID 0xC11E0768
...
char* lldp_get_str_chassis(struct lldpd_chassis *);
char* lldp_get_str_port(struct lldpd_port *);
...
struct lldpd {
	...
	int(*g_iface_cb)(struct lldpd *);	      /* Called when there is an interface change */
