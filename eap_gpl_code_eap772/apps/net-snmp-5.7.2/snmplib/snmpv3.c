...
/* Add By Han Renjie, 10Mar2020 */
/* 解决64位系统下engineIDType为ENGINEID_TYPE_NETSNMP_RND时，使用sizeof(time_t)计算得到的engineID
 * 长度过长导致不符合RFC3411,改为使用MAC地址来生成engineID */
static unsigned int engineIDType = ENGINEID_TYPE_MACADDR;
/* Add end */
