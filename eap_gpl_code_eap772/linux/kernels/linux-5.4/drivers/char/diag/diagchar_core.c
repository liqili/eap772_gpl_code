...
#if defined(CONFIG_DIAG_MAJOR_NUM) && (CONFIG_DIAG_MAJOR_NUM > 0)
	dev = MKDEV(CONFIG_DIAG_MAJOR_NUM, driver->minor_start); 
    ret = register_chrdev_region(dev, driver->num, driver->name);
#else
