	...
	create: function(defaults, options){
		...
		me.each(function(i, obj){
			...
			if (!viewOnly){
				...
				inHTML +=						"<button type=\"button\" class=\"button-button btn-msg btn-msg-cancel\">"+$.su.CHAR.OPERATION.CANCEL+"</button>";
				inHTML +=					"</div>";
				inHTML +=					"<div class=\"button-container inline\">";
				inHTML +=						"<button type=\"button\" class=\"button-button btn-msg btn-msg-reset\">"+$.su.CHAR.OPERATION.RESET+"</button>";
				inHTML +=					"</div>";
				inHTML +=					"<div class=\"button-container inline\">";
				inHTML +=						"<button type=\"button\" class=\"button-button btn-msg btn-msg-ok\">"+$.su.CHAR.OPERATION.OK+"</button>";
				inHTML +=					"</div>";
				inHTML +=				"</div>";
				inHTML +=			"</div>";
			};	
